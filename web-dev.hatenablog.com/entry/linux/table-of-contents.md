...
## 全般
- [どのディストリビューションを使うか？](/entry/linux/select-distribution)
...
## CentOS
- [日本語環境に設定](/entry/linux/centos/lang-jp)
- [日本時刻に設定（ntpd, ntpdate, timezone, localtime）](/entry/linux/centos/time-jp)
